...
import { postEditSchema, postCreateSchema } from '@/lib/validations/admin-post'
...
export async function approvePost(postId: string) {
  ...
  revalidatePath('/dashboard/posts/pending')
  return { success: true }
}
