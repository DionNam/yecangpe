#!/usr/bin/env python3
"""
Combine all mini-batches into one INSERT statement
"""
...
# Write combined file
with open('all_remaining_combined.sql', 'w') as f:
    f.write(header + '\n')
    f.write(',\n'.join(all_postings))
    f.write(';\n')

print(f"Created all_remaining_combined.sql with {len(all_postings)} postings")
